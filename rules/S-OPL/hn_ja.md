...
2. 技術委員(OC)がHuman Navigatioin プログラムを起動する．

3. 被験者がMeta Quest 2を装着．
...
- **セッションが残っている場合**:
  ...
  - 被験者は次のチームエリアに移動し，Meta Quest 2を装着する．
...
## セッション数と制限時間
タスクは**12**セッションで構成され，各セッションの制限時間は**3**分です．
